...
def show_go_screen():
    ...
    draw_text(screen, "EN ESTE JUEGO DEBES ROMPER TU RECORD DISPARANDO A LOS METEORITOS", 27, WIDTH // 2, HEIGHT // 2)

    # Agregar texto y entrada para el nombre
    draw_text(screen, "Ingresa tu nombre:", 27, WIDTH // 2, HEIGHT * 3/4)
    input_box = pygame.Rect(WIDTH // 2 - 100, HEIGHT * 3/4 + 40, 200, 32)
    ...
    while is_typing:
        ...
        draw_text(screen, input_text, 32, WIDTH // 2, HEIGHT * 3/4 + 40)
